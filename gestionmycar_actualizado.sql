...
CREATE TABLE `vehiculos` (
  ...
  `deleted_at` datetime DEFAULT NULL -- Campo para Baja Lógica de Vehículos
...
CREATE TABLE `usuarios` (
  ...
  `deleted_at` datetime DEFAULT NULL -- Campo para Baja Lógica de Clientes/Usuarios
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `alquileres` (
  ...
  `id_vehiculo` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `estado` enum('reserva','alquiler','devuelto') NOT NULL DEFAULT 'reserva' -- Control del ciclo de vida
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- Se recomienda usar RESTRICT o mantener CASCADE teniendo en cuenta que el borrado
-- desde la app siempre será lógico y nunca físico (lo cual preserva los datos).
ALTER TABLE `alquileres`
